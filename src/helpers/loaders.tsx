export const insertBodyLoader = () => {
  ...
  if (_body) {
    ...
    _body.insertAdjacentHTML(
      "afterbegin",
      '<div id="body-loader" class="tw-h-full tw-w-full tw-flex tw-justify-center tw-items-center tw-z-[9999] tw-bg-white tw-opacity-80 tw-absolute tw-overflow-hidden">' +
