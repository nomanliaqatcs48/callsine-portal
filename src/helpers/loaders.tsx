  ...
  if (_body) {
    ...
    if (_root) {
      _root.insertAdjacentHTML(
        "afterbegin",
        '<div id="body-loader" class="tw-h-full tw-w-full tw-flex tw-justify-center tw-items-center tw-z-[9999] tw-bg-white tw-opacity-60 tw-absolute tw-overflow-hidden">' +
