        ...
        <>
          <Card variant="outlined" className="tw-h-full lg:tw-rounded-none">
            <Box className="tw-h-full lg:tw-flex lg:tw-flex-col lg:tw-justify-between">
              <Box className="plan-title-container tw-py-[10px] tw-px-[20px] tw-border-b tw-border-[#dfe1e6] lg:tw-px-[30px]">
                <Typography
                  variant="h3"
              ...
              <Box className="price-container lg:tw-px-[30px]">
                <Box className="price-per tw-py-5">
              ...
              <Box className="button-container tw-px-[20px] tw-border-b tw-border-[#dfe1e6] lg:tw-px-[30px]">
                <Button
                  variant="contained"
                  color="primary"
