    ...
    <Box className={props?.className} sx={{ zIndex: "999" }}>
      {children || (
        <>
          ...
          >
            <CardContent
              className="tw-h-full tw-py-10 tw-px-10 lg:tw-flex lg:tw-flex-col lg:tw-justify-between"
              sx={{
                "&:last-child": {
                  paddingBottom: { lg: 0 },
                },
            ...
            >
              ...
              <Typography className="tw-text-[#36313D] tw-text-[16px] tw-font-normal tw-leading-[28px] tw-pt-[45px] lg:tw-text-[18px]">
                {item?.description ||
                  props?.description ||
              ...
              <Button
                variant="contained"
                color="primary"
                className={`tw-text-[18px] tw-font-normal tw-w-full tw-py-[12px] tw-my-[40px] tw-shadow-none ${
                  isMostPopular
